...
<html lang="en">
<head>
	<title>Daftar Sebagai Pelanggan</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('{{ asset('template/login/images/bg-02.jpg') }}');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54" style="width:500px;">
                <form class="login100-form validate-form" role="form" method="POST" action="{{ url('/user/register') }}">
                    @csrf
					...
					<div class="flex-col-c p-t-30">
						<span class="txt1 p-b-17">
							Sudah punya akun ? <a href="{{ url('/user/login') }}" class="txt2"><b><u>Login</u></b></a>
						</span>
					</div>
				</form>
			</div>
